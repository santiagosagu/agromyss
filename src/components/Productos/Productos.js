...
const productos = [
    {
        ...
        productos: [
            ...
            {
                id: 3,
                nombre: 'Barra de chocolate - frambuesa - manzanilla - manzana - cacao nibs',
                precio: 40000,
                img: [
...
const productosIngles = [
    {
        ...
        url: 'chocolatinas',
        productos: [
            { id: 1, nombre: 'chocolatina1', precio: 20000, img: 'https://w7.pngwing.com/pngs/465/541/png-transparent-chocolate-bar-hot-chocolate-white-chocolate-cream-three-kinds-of-delicious-chocolate-food-wafer-three-dimensional-thumbnail.png' },
            { id: 2, nombre: 'chocolatina2', precio: 30000, img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS2iokHfTo4L9wdI0aTYI6RMOG3WvrHT6ZFIA&usqp=CAU' },
            { id: 3, nombre: 'chocolatina3', precio: 40000, img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRzotNu__X-rglTpW5lM2LwYPloONdHpqwPzQ&usqp=CAU' },
            { id: 4, nombre: 'chocolatina3', precio: 40000, img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ-e987T4ZT8L4I7ClnwKVbz2KOcM0rd-DaVA&usqp=CAU' },
            { id: 5, nombre: 'chocolatina3', precio: 40000, img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT3VTgbEa6DMeWNbK18rBRsSSBV7EFEvhW7JQ&usqp=CAU' },
            { id: 6, nombre: 'chocolatina3', precio: 40000, img: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQhhYFLJVUAsSVEwUwHDrYKl6r3LCTaB_xYRA&usqp=CAU' },
        ],
    },
    {
        id: 2,
                                    ...
                                    <div className='producto-card'>
                                        {item.productos.map(product => (
                                            <div className='producto-card-content'>
                                                <img src={product.img[0]} alt="" onClick={() => verProducto(item.url, product.url)}/>
                                    ...
                                    <div className='producto-card'>
                                        {item.productos.map(product => (
                                            <div className='producto-card-content'>
                                                ...
                                                <button className='btn btn-primary my-2'>Añadir al carrito</button>
                                            </div>
                                        ))
                                        }
                                    </div>
