...
const Contacto = () => {
    ...
    const FnFormularios = () => {
        if (formulario.length === 0) {
            if (idioma === 'español') {
                return (
                    <div className='botones'>
                        <h3 onClick={() => setFormulario('quiero-comprar')}>Quiero Comprar</h3>
                        <h3 onClick={() => setFormulario('quiero-vender')}>Quiero Vender</h3>
            ...
            return <FormContacto tipoForm={idioma === 'español' ? 'comprar' : 'Purchase'} />

        } else if (formulario === 'quiero-vender') {
            return <FormContacto tipoForm={idioma === 'español' ? 'vender' : 'Sell'} />
        } else if (formulario === 'pqrs') {
            return <FormContacto tipoForm={'pqrs'} />
        } else if (formulario === 'otro') {
            return <FormContacto tipoForm={idioma === 'español' ? 'otro' : 'Others'} />
        }
    }
