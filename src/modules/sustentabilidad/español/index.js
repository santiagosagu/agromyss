    ...
    <Component>
      <div className="container">
        ...
        <p>
          ...
          largo plazo depende de la sostenibilidad de su propia produccion y de
          la redes de agricultores locales y del suministro de una cantidad
          suficiente de productos de calidad para satisfacer las necesidades de
          los clientes de AGROMYSS. Por esta razón, AGROMYSS trabaja en estrecha
          colaboración con los agricultores para ayudarlos a mejorar los
          rendimientos, la calidad y, a su vez, sus ingresos. Con capacitación,
          acceso a mercados, insumos y tecnología, los agricultores pueden
          producir más y mejores productos. Al proporcionar servicios valiosos a
          los agricultores, como asistencia para obtener certificaciones
          reconocidas internacionalmente, AGROMYSS tiene como objetivo ganarse
          su lealtad como su comprador preferido y puede ofrecer productos y
          soluciones diferenciados a los clientes más exigentes.
        </p>
        ...
        <p>
          ...
          programas de sostenibilidad. Este modelo descentralizado ha funcionado
          bien a AGROMYSS durante varios años porque cada mercado local y cada
          cadena de suministro de productos básicos es diferente. Cada empresa
          local de AGROMYSS desarrolla estrategias de abastecimiento y
          desarrollo de agricultores que reflejan las necesidades locales de los
          agricultores y sus realidades comerciales. Las cadenas de suministro
          rastreables garantizan la ausencia de trabajo infantil y forzoso. Se
        ...
        <p>
          ...
          ascender, siendo cada paso un precursor del siguiente. En su madurez,
          al proporcionar un paquete de servicios de capacitación y
      ...
      <div className="container">
        ...
        <p>
          ...
          pequeños agricultores con capacitación, transferencia de tecnologia y
          certificación para brindar servicios de valor agregado con el objetivo
          de una gestión efectiva, transparencia y rendición de cuentas asus
          socios.
        </p>
        ...
        <p>
          ...
          brindar capacitación, realizar evaluaciones crediticias y facilitar el
        ...
        <p>
          ...
          asociación con agencias de desarrollo, ONG, clientes e inversionistas.
          Estos socios se involucran con AGROMYSS en asociaciones
          público-privadas, reconociendo el bien público que es un componente de
          este trabajo.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            estrategicas ayudan a mitigar el riesgo y los costos de inversion y
            operacion.
          </li>
          <li>
            ...
            agricultores. La mano de obra y la recopilación de datos de cada una
            de estas actividades se apalancan entre sí, haciéndolas
      ...
      <div className="container">
        ...
        <p>
          ...
          sostenibilidad de AGROMYSS. Es decir, trabajar de una manera que cree
          valor compartido para los pequeños agricultores. AGROMYSS facilita su
          participación en sus programas y, al hacerlo, genera un impacto
          positivo en las regiones donde opera.
        </p>

        <p>
          El trabajo de sostenibilidad de AGROMYSS es un desafío debido a la
          cantidad y diversidad de agricultores, y sin una estrategia comercial
          inclusiva no sería posible. Los consumidores de todo el mundo y las
          empresas que les suministran productos son cada vez más conscientes.
          Esta tendencia representa la mayor oportunidad de AGROMYSS. Es posible
          que los consumidores no estén dispuestos a pagar más, pero están
          dispuestos a dar preferencia a las marcas que demuestren que están
      ...
      <div className="container">
        ...
        <p>
          ...
          importante para crear productos de mayor valor agregado y aumentar la
          eficiencia de la cadena de suministro. AGROMYSS pretende ser líder de
          la industria en trazabilidad tanto en cacao, mango de azucar como en
          productos con valor agregado generado de estos y subproductos.
        </p>
      </div>
      ...
      <div className="container">
        ...
        <p>
          En AGROMYSS CACAO estamos expandiendo continuamente nuestra presencia
          para brindar un servicio superior y productos de cacao de calidad para
          satisfacer las necesidades de nuestros clientes. Nuestras operaciones,
          que están involucradas en la produccion, el comercio, procesamiento,
          envío y entrega de productos y subproductos de cacao, participan en
      ...
      <div className="container">
        ...
        <p>
          ...
          organizacion de las comunidades productoras de cacao pueden mejorar su
          calidad de vida.
        </p>

        <p>
          La gran mayoría del cacao del mundo proviene de pequeños productores.
          La producción de cacao en pequeña escala se caracteriza por un bajo
          uso de insumos, baja inversión, inadecuadas practicas agricolas lo que
          conlleva a baja produccion, lo que resulta en bajos ingresos y
          utilidades.
        </p>

        <p>
          A medida que la demanda de cacao continúa aumentando y la tierra para
          el cacao nuevo es limitada, el desafío en el cultivo del cacao hoy es
          impulsar los rendimientos y hacer del cultivo del cacao un medio de
          vida atractivo y sostenible para los agricultores en el futuro.
          AGROMYSS cree que a través de sus programas, la sostenibilidad puede
          asegurarse, mediante la mejora de las prácticas agrícolas, el uso
          eficiente de insumos y un conocimiento basico financiero.
          Transformando estas granjas en medio de vida productivos y rentables a
          largo plazo.
        </p>

        <p>
          Las iniciativas de AGROMYSS para el cacao sostenible se enfocan en
          capacitar a los agricultores en buenas prácticas agrícolas enfocadas a
          una buena produccion pero tambien en la generacion de granos de alta
          calidad, garantizando un sistema de trazabilidad efectivo que permita
          un mejor conocimiento de los cultivos y la oportunidad de desarrollar
          las intervenciones adecuadas.
        </p>

        <p>
          Para lograr un programa tan ambicioso, AGROMYSS cree firmemente en las
          alianzas estrategicas y el diálogo abierto con todos los miembros de
          la produccion y de la cadena de suministro.
        </p>
      </div>
    </Component>
  );
